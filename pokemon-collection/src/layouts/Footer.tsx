...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      className="bg-[#030712] text-[#FAFAF9] border-t border-[#FAFAF9]/10 py-6 px-4 mt-auto"
        ...
        <div className="flex justify-center">
          <nav className="flex" aria-label="Footer navigation">
            <ul className="list-none p-0 m-0 flex gap-[22px] flex-wrap justify-center">
              <li>
                <Button
                  className="text-[#FAFAF9] no-underline tracking-[0.2px] hover:underline hover:decoration-4 hover:text-white"
                  href="#"
                >
                  Privacy Policy
                </Button>
